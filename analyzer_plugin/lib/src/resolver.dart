...
class HtmlTemplateResolver {
  ...
  HtmlTemplateResolver(
      this.typeProvider, this.source, this.view, this.errorListener);
  ...
  Template resolve() {
    ...
    fragmentText = source.contents.data;
    // Parse HTML.
    ...
    template = new HtmlTemplate(view, document, source);
  ...
  void _reportErrorForSpan(SourceSpan span, ErrorCode errorCode,
    ...
    errorListener.onError(new AnalysisError(
        source, span.start.offset, span.length, errorCode, arguments));
  }
...
/// [DartTemplateResolver]s resolve [View] templates.
