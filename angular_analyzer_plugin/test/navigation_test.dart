...
class AngularNavigationTest extends AbstractAngularTest {
  ...
  void setUp() {
    ...
    when(collector.addRegion(
      ...
      final targetKind = invocation.positionalArguments[2] as protocol.ElementKind;
      final targetLocation = invocation.positionalArguments[3] as protocol.Location;
...
''';
  ...
  void _findRegionString(String str, String suffix, {final String codeOverride}) {
